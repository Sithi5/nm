...
void set_nm_structure(t_nm *nm) {
    ...
    nm->elf_data.symtab_strtab_section.elf32 = NULL;
    nm->elf_data.symtab_strtab_section.elf64 = NULL;
    nm->elf_data.sh_strtab_section.elf32 = NULL;
    nm->elf_data.sh_strtab_section.elf64 = NULL;
